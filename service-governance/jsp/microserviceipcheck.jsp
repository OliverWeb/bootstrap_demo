...
<title>microserviceipcheck</title>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/microserviceipcheck.js"></script>
<style>
...
<body>
		...
		<div style="width: 100%; text-align:center;">
			<div style="text-align:center;white-space: nowrap;"><b style="color:blue"><font color="red"  size="5px">[微服务节点配置待审核列表]</font></b></div>
		</div>
			</br>
		<div id="tb">

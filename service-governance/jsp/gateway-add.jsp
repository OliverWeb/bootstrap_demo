		...
		<center>
			<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr style="height:20px;">
							...
							<td ><input type="text"  value=""  name='name' ><font color="red"   size="2px">*</font> </td>
					</tr>
				...
				<!-- 	<tr style="height:50px;">
							<td style="text-align:right;vertical-align:bottom;width:35%;"><font  size="3px">状态</font></td>
							<td style="vertical-align:bottom;padding-left:20px;"><select class="select_gallery"  name='status' style="width:250px;" ><option value="active">正常</option><option value="inactive">降级</option></select></td>			
					</tr> -->
					<tr style="height:20px;">
					...
					<tr style="height:50px;"><td colspan="2" style="text-align:center;vertical-align:bottom;"><input type="button" value="提交" onclick="add();" /></tr>
			</table>
		</center>
</body>
</html>
...
$(function(){ 
	...
	setselect($("select[name='nameandversion']").val());

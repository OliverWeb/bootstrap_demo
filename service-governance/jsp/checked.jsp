...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/checked.js"></script>
<style>
...
<body>
		...
		<div style="width: 100%; text-align:center;">
			<div style="text-align:center;white-space: nowrap;"><b style="color:blue"><font color="red"  size="5px">[公网网关服务已审核操作列表]</font></b></div>
		</div>
		</br>
		<div id="tb">

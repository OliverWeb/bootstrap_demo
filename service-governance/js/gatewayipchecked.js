var data=[];
$.get("../gatewayipchecked/list/",function(result){
	if(result)
	{
		for(var i=0;i<result.length;i++)
		{
			...
			data[i]={ip:ip,port:port,displaystatus:displaystatus,displayweight:displayweight,displaybeta:displaybeta,displayconnections:displayconnections,displayfails:displayfails,createtime:createtime};
		}
	}
	$('#dg').datagrid({ loadFilter: pagerFilter }).datagrid({
		...
		columns:[[
		  		...
		  		{field:'createtime',title:'审核时间',width:'20%',sortable:true,sorter:function(a,b){
		  			a=a;
                	b=b;
                    if(a < b)
                        return -1;

var data=[];
$.get("../microservicemethodcheck/list/",function(result){
	if(result)
	{
		for(var i=0;i<result.length;i++)
		{
			...
			{
				displayDefaultVersion=info.split(":")[0]+"<font size='2px' >(更新后)</font></br>"+beforeInfo.split(":")[0]+"<font size='2px' >(当前)</font></br>";
			}
			...
			{
				displayExecutionTimeout=info.split(":")[1]+"<font size='2px' >(更新后)</font></br>"+beforeInfo.split(":")[1]+"<font size='2px' >(当前)</font></br>";
			}
			...
			{
				displayGrayVersion=info.split(":")[2]+"<font size='2px' >(更新后)</font></br>"+beforeInfo.split(":")[2]+"<font size='2px' >(当前)</font></br>";
			}
			...
			{				
				displayTarget=changeTarget(info.split(":")[3])+"<font size='2px' >(更新后)</font></br>"+changeTarget(beforeInfo.split(":")[3])+"<font size='2px' >(当前)</font></br>";			
			}
			...
			{
				displayRate=info.split(":")[4]+"<font size='2px' >(更新后)</font></br>"+beforeInfo.split(":")[4]+"<font size='2px' >(当前)</font></br>";
			}
			...
			{
				displayTags=replace(info.split(":")[5])+"<font size='2px' >(更新后)</font></br>"+replace(beforeInfo.split(":")[5])+"<font size='2px' >(当前)</font></br>";
			}
			...
			{
				displayWhiteList=replace(info.split(":")[6])+"<font size='2px' >(更新后)</font></br>"+replace(beforeInfo.split(":")[6])+"<font size='2px' >(当前)</font></br>";
			}
			...
			{
				displayBlackList=replace(info.split(":")[7])+"<font size='2px' >(更新后)</font></br>"+replace(beforeInfo.split(":")[7])+"<font size='2px' >(当前)</font></br>";
			}
			        ...
			        onOk: function(){
			        	$("input[name='checkbox']").each(function(){
							if($(this).prop("checked"))
							{
								...
								$.ajax({
							        type: "POST",
							        url: "../microservicemethodchecked/insert?checkid="+value.id,
				        ...
				        onOk: function(){
				        	$("input[name='checkbox']").each(function(){
								if($(this).prop("checked"))
								{
									...
									$.ajax({
								        type: "GET",
								        url: "../microservicemethodcheck/delete?id="+value.id,
								        contentType: "application/json",
								        dataType: "json",
								        async: false,
								        success: function (result) {     	

...
<div style="text-align:left;white-space: nowrap;">
	<a style="color: blue; text-decoration:none;font-size: 15px;"href="javascript:void(0)"  id="updateing" onclick="window.parent.Open('公网网关节点配置待审核','gatewayipcheck.jsp')"></a>
	...
	$(function(){
		...
		$("body").on("click","a",function(){
			if($(this).attr("class")=="update")
			{
				...
				{
					var data={ip:host,port:port,beforeStatus:beforestatus,beforeWeight:beforeweight,beforeBeta:beforebeta,beforeConnections:beforeconnections,beforeFails:beforefails,status:status,weight:weight,beta:beta,connections:connections,fails:fails,createtime:getMyDate(new Date())};
					$.ajax({
						type: "POST",
